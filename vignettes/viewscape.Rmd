...
test_metrics <- viewscape::calculate_viewmetrics(output[[1]], test_dsm, test_dtm)
```
...
test_diversity <- calculate_diversity(test_landcover, output[[1]], proportion = TRUE)
```
...
test_canopy_proportion <- viewscape::calculate_feature(landuse = test_canopy, 
                                                    dsm = test_dsm,
