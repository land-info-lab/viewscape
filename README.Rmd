...
<!-- badges: start -->
  ...
  [![Codecov test coverage](https://codecov.io/gh/billbillbilly/viewscape/branch/master/graph/badge.svg)](https://codecov.io/gh/billbillbilly/viewscape?branch=master)
  <!-- badges: end -->
...
For further information on the rest of the functions available in this package please refer to the [package website](needs to be created). For more information and examples of the functions check out the [package vignette](needs to be created).
