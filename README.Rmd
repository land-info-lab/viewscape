...
Based on the viewshed, a set of configuration metrics can be calculated, including:
...
6. Skyline: Variation of (Standard deviation) of the vertical viewscape (visible canopy and buildings).\n
7. Shannon diversity index: Based on the number of land use/cover classes and the proportion of distribution.\n
8. Proportion of other object: Building, trees, or paved surface.
